...
const Re = "copilot-", ts = "24.4.11", Dl = "attention-required", Cl = "https://plugins.jetbrains.com/plugin/23758-vaadin", Tl = "https://marketplace.visualstudio.com/items?itemName=vaadin.vaadin-vscode", Vl = (e, t, r) => t >= e.left && t <= e.right && r >= e.top && r <= e.bottom, rs = (e) => {
  const t = [];
  let r = is(e);
  for (; r; )
...
function Vs() {
  ve.push(import("./copilot-log-plugin-D6RxsXDl.js")), ve.push(import("./copilot-info-plugin-CdCy8Opj.js")), ve.push(import("./copilot-features-plugin-B5bgI65F.js")), ve.push(import("./copilot-feedback-plugin-BN2c0yrL.js")), ve.push(import("./copilot-shortcuts-plugin-RNhLCaA_.js"));
}
function js() {
  {
...
const Ls = Wi(Or);
function Xi() {
  return import("./copilot-notification-D2QKxRb4.js");
}
const Ms = (e) => {
...
let xn = class extends Ts {
  ...
  async init() {
    if (this.initialized)
      return;
    await window.Vaadin.copilot._machineState.initializer.promise, document.body.style.setProperty("--dev-tools-button-display", "none"), await import("./copilot-global-vars-later-DTPa1Qhg.js"), await import("./copilot-init-step2-CqkG0sue.js"), Vs(), this.tabIndex = 0, Ot.hostConnectedCallback(), window.addEventListener("keydown", wn), $.onSend(this.handleSendEvent), this.removers.push($.on("close-drawers", this.closeDrawers.bind(this))), this.removers.push(
